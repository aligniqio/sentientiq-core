...
const NeuralBackground: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Animated color overlays for backlighting */}
      <div className="fixed inset-0 pointer-events-none" style={{ zIndex: 1 }}>
        ...
        {/* Purple pulse */}
        <div
          className="absolute inset-0 opacity-20 animate-pulse-slow-reverse"
          style={{
        ...
        {/* Cyan accent */}
        <div
          className="absolute inset-0 opacity-10 animate-pulse-slow-reverse"
          style={{
